...
jQuery(function($) {
    ...
    /*--------------------------------
         CHAT API Scroll
     --------------------------------*/
    _SETTINGS.chatApiScroll = function() {
    ...
    /*--------------------------------
         CHAT API window
     --------------------------------*/
    _SETTINGS.chatApiWindow = function() {
    ...
    /*--------------------------------
        Viewport Checker
     --------------------------------*/
    _SETTINGS.viewportElement = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.draggablePanels = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.breadcrumbAutoHidden = function() {
    ...
    /*--------------------------------
         Section Box Actions
     --------------------------------*/
    _SETTINGS.sectionBoxActions = function() {
    ...
    /*--------------------------------
         Main Menu Scroll
     --------------------------------*/
    _SETTINGS.mainmenuScroll = function() {
    ...
    /*--------------------------------
         Mailbox
     --------------------------------*/
    _SETTINGS.mailboxInbox = function() {
    ...
    /*--------------------------------
         Extra form settings
     --------------------------------*/
    _SETTINGS.extraFormSettings = function() {
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    _SETTINGS.jvectorMaps = function() {
    ...
    /*--------------------------------
         Pretty Photo
     --------------------------------*/
    _SETTINGS.loadPrettyPhoto = function() {
    ...
    /*--------------------------------
         Gallery
     --------------------------------*/
    _SETTINGS.isotopeGallery = function() {
    ...
    /*--------------------------------
         Tocify
     --------------------------------*/
    _SETTINGS.tocifyScrollMenu = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.nestableList = function() {
    ...
    /*--------------------------------
         Tooltips & Popovers
     --------------------------------*/
    _SETTINGS.tooltipsPopovers = function() {
    ...
    /*--------------------------------
         Form Editors
     --------------------------------*/
    _SETTINGS.formEditors = function() {
    ...
    /*--------------------------------
         Custom Dropzone
     --------------------------------*/
    _SETTINGS.customDropZone = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.otherScripts = function() {
    ...
    /*--------------------------------
        weather widget
     --------------------------------*/
    _SETTINGS.WidgetWeather = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.ToDoAddTaskWidget = function() {
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    _SETTINGS.dbjvectorMap = function() {
    ...
    /*--------------------------------
        IOS7 Switchery
     --------------------------------*/
    _SETTINGS.ios7Switchery = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    _SETTINGS.widgetSparklineChart = function() {
